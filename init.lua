...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'kotlin', 'rust', 'python' },
      ...
      incremental_selection = {
        enable = true,
        keymaps = {
          init_selection = 'gss', -- Start incremental selection
          node_incremental = 'gsi', -- Increment to the upper named parent
          scope_incremental = 'gsc', -- Increment to the upper scope (e.g. function, class, etc.)
